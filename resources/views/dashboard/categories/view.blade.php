...
<div class="card-box mb-30">
	<form method="post" action="{{route('supervisor.categories.update',@$category->id)}}" enctype="multipart/form-data">
					@csrf
					<div class="pd-20">
						<h4 class="text-blue h4">Categories Edit / {{@$category->name}}</h4>
					</div>
					<div class="pd-20">
						<div class="row pd-20">
