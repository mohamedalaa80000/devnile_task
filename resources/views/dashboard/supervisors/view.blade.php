...
<div class="card-box mb-30">
	<form method="post" action="{{route('admin.supervisors.update',@$supervisor->id)}}" enctype="multipart/form-data">
					@csrf
					<div class="pd-20">
						<h4 class="text-blue h4">Supervisors Edit / {{@$supervisor->username}}</h4>
					</div>
					<div class="pd-20">
						<div class="row pd-20">
					...
					<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" value="{{@$supervisor->username}}" name="username">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">{{__('Phone')}}</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" value="{{@$supervisor->phone}}" name="phone">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">{{__('Email')}}</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="email" value="{{@$supervisor->email}}" name="email">
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input type="checkbox" @if($supervisor->status == 'ON') checked @endif class="switch-btn" name="status" data-color="#0099ff">
							</div>
						</div>
						<div class="form-group row">
